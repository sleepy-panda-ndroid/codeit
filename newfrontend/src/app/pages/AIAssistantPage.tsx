...
export default function AIAssistantPage() {
  ...
  const conversations: Conversation[] = [
    ...
    },
    {
      ...
      lastMessage: 'Property does not exist on type...',
      timestamp: new Date(Date.now() - 7200000),
    },
    {
      id: '3',
      title: 'API Integration Help',
      lastMessage: 'How to handle async requests?',
    ...
    <div className="h-screen bg-[#1e1e1e] flex overflow-hidden">
      ...
      <div className="w-80 bg-[#252526] border-r border-[#3e3e42] flex flex-col">
        ...
        <ScrollArea className="flex-1 p-4">
          <Button className="w-full mb-4 bg-indigo-600 hover:bg-indigo-700 text-white">
          ...
          <div className="space-y-2">
            {conversations.map((conv) => (
              <Card
                key={conv.id}
                className="bg-[#1e1e1e] border-[#3e3e42] p-3 hover:bg-[#2a2d2e] cursor-pointer transition-colors"
